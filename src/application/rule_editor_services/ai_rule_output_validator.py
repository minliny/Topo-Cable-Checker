...
class AiSchemaValidationResult:
    is_valid: bool
    schema_errors: List[AiSchemaValidationError]
...
class AiRuleOutputValidator:
    ...
    def validate(cls, raw_output: Any, schema: AiDraftSchema) -> AiSchemaValidationResult:
        ...
        if not isinstance(rule_type, str) or not rule_type.strip():
            ...
            return AiSchemaValidationResult(False, errors, None, cls._as_str(target_type), cls._as_str(severity), cls._as_dict(rule_definition))
        ...
        if rule_type_schema is None:
            ...
            return AiSchemaValidationResult(False, errors, rule_type, cls._as_str(target_type), cls._as_str(severity), cls._as_dict(rule_definition))
        ...
        if not isinstance(rule_definition, dict):
            ...
            return AiSchemaValidationResult(False, errors, rule_type, cls._as_str(target_type), cls._as_str(severity), None)
